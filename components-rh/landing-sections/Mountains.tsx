...
export const Mountains: FunctionComponent = () => {
	...
	return (
		<section ref={contentWrapperRef} className="h-screen relative">
			...
			<motion.div
				style={{ y: header }}
				className="w-full flex justify-center absolute items-center pt-[calc(100vh/4)] will-change-transform"
			>
				<Image
...
export const MountainCaves: FunctionComponent = () => {
	return (
		<section className="min-h-screen bg-[#2d112b] relative z-10">
			<div className="w-full min-h-screen grid grid-cols-2 grid-rows-2 max-w-[1000px] mx-auto pt-[100px]">
