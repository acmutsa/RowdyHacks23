...
const SponsorCard: FunctionComponent<Sponsor> = (sponsor) => {
	...
	return (
		<Link href={sponsor.link} target="_blank">
			<div className="w-full aspect-[3/2] flex items-center justify-center relative shadow-xl box-border hover:cursor-pointer bg-gray-800 rounded-t-xl border-b-0 border-gray-900 border-4 bg-[url('https://static.rowdyhacks.org/img/landing/ocean_tablet_stats.svg')] bg-cover bg-center bg-no-repeat">
