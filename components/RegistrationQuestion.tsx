...
function Question(props) {
	if (props.type === 'text') {
		return (
			<Fragment>
				...
				<Field
					...
					className="border-2 border-gray-400 rounded-md p-1 text-black"
				/>
				<ErrorMessage
					name={props.question.name}
		...
		return (
			<Fragment>
				...
				<Field
					...
					name={props.question.name}
					id={props.question.id}
					className="border-2 border-gray-400 rounded-md p-1 mr-auto text-black"
				>
		...
		return (
			<Fragment>
				<label htmlFor={props.question.name} className="mt-4 font-sans font-bold">
					{props.question.required ? '*' : ''}
					{props.question.question}
				</label>
