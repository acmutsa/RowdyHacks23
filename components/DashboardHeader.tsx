	...
	return (
		<section>
			<header className="md:inline hidden justify-center py-2 md:p-4 items-center">
				<div className="mx-auto flex flex-wrap justify-center lg:text-xl text-lg font-header text-center border-2 border-rh-sunset rounded-lg py-2 font-bold text-rh-sunset">
					...
					<NavLink href="/music" exact={true} className="mx-4">
						Music
					</NavLink>
				</div>
			</header>
